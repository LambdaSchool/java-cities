...
public class CitiesApplication {
    ...
    public static final String QUEUE_NAME_CITY1 = "Cities1Priority";
    public static final String QUEUE_NAME_CITY2 = "Cities2Priority";
    public static final String QUEUE_NAME_SECRET = "SecretPriority";
